...
{
    [MetadataType(typeof(SeaConditionMetaData))]
    public partial class SeaCondition : StateObject
    {
    	...
    	private void FixupTripLogs(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.SeaCondition, this))
    				{
    					item.SeaCondition = null;
    				}
    			}
    		}
    	}
